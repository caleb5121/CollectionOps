    ...
    <div className={bodyScrollClass}>
          ...
          {phase === "done" && insights.length > 0 ? (
            <div className="space-y-3.5">
              {degraded ? (
                <div role="status" className="rounded-lg border border-amber-300/80 bg-amber-50/90 px-3 py-2 dark:border-amber-700/50 dark:bg-amber-950/35">
                  <p className="text-xs font-semibold text-amber-900 dark:text-amber-200">Quick insights (local)</p>
